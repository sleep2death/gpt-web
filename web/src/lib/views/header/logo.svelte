<div class="flex flex-row h-full items-center mx-2 lg:mx-4">
  ...
  <h1 class="text-lg font-bold cursor-default text-secondary">GPT-WEB</h1>
  <span
    class="text-xs align-top self-start px-1 mt-2 rounded cursor-default text-secondary"
  >
    beta
  </span>
</div>
